...
export const S1_HeadlineSection = () => (
  <section className="relative min-h-screen flex items-center justify-center grid-bg scan-lines overflow-hidden">
    ...
    <div className="relative z-10 max-w-3xl mx-auto px-5 text-center py-24 md:py-32">
      ...
      <FadeIn delay={0.15}>
        <p className="text-muted-foreground text-base md:text-lg font-medium mb-10 max-w-2xl mx-auto leading-relaxed">
      ...
      <FadeIn delay={0.4}>
        <motion.div
          className="glow-line w-16 mx-auto mt-12"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
